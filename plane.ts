...
export function expandPlane(obj):IPlane{
    if(planeTemplates.hasOwnProperty(obj.type)){
      var parts:Part[] = clone(planeTemplates[obj.type]);
      var p:IPlane = <IPlane> {parts:parts};
